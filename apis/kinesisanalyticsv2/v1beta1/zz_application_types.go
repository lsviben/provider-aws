...
type Application struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.runtimeEnvironment) || has(self.initProvider.runtimeEnvironment)",message="%!s(MISSING) is a required parameter"
