...
type LoggingConfiguration struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.loggingConfiguration) || has(self.initProvider.loggingConfiguration)",message="%!s(MISSING) is a required parameter"
