...
type AnomalyMonitor struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.monitorType) || has(self.initProvider.monitorType)",message="%!s(MISSING) is a required parameter"
