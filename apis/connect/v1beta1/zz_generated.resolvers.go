...
func (mg *LambdaFunctionAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.FunctionArn),
		Extract:      resource.ExtractParamPath("arn", true),
		Reference:    mg.Spec.InitProvider.FunctionArnRef,
		Selector:     mg.Spec.InitProvider.FunctionArnSelector,
		To: reference.To{
			List:    &v1beta16.FunctionList{},
			Managed: &v1beta16.Function{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.FunctionArn")
	}
	mg.Spec.InitProvider.FunctionArn = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.FunctionArnRef = rsp.ResolvedReference
