...
type ServiceLinkedRole struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.awsServiceName) || has(self.initProvider.awsServiceName)",message="%!s(MISSING) is a required parameter"
