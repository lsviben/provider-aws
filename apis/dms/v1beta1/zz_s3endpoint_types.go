...
type S3Endpoint struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.bucketName) || has(self.initProvider.bucketName)",message="%!s(MISSING) is a required parameter"
