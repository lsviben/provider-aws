...
type EventSubscription struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.eventCategories) || has(self.initProvider.eventCategories)",message="%!s(MISSING) is a required parameter"
