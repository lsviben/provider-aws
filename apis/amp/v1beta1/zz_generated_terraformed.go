...
// GetIgnorableFields of this AlertManagerDefinition
func (tr *AlertManagerDefinition) GetIgnorableFields() ([]string, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
// GetIgnorableFields of this RuleGroupNamespace
func (tr *RuleGroupNamespace) GetIgnorableFields() ([]string, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
