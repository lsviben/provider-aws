...
type SigningProfile struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.platformId) || has(self.initProvider.platformId)",message="%!s(MISSING) is a required parameter"
