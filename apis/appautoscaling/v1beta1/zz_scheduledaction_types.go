...
type ScheduledAction struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.scalableTargetAction) || has(self.initProvider.scalableTargetAction)",message="%!s(MISSING) is a required parameter"
