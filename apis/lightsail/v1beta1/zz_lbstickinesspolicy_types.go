...
type LBStickinessPolicy struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.cookieDuration) || has(self.initProvider.cookieDuration)",message="%!s(MISSING) is a required parameter"
