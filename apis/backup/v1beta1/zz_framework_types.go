...
type Framework struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.control) || has(self.initProvider.control)",message="%!s(MISSING) is a required parameter"
