...
type RemediationConfiguration struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.targetType) || has(self.initProvider.targetType)",message="%!s(MISSING) is a required parameter"
