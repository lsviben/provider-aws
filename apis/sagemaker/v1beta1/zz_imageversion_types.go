...
type ImageVersion struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.baseImage) || has(self.initProvider.baseImage)",message="%!s(MISSING) is a required parameter"
