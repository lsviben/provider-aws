...
type GatewayResponse struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.responseType) || has(self.initProvider.responseType)",message="%!s(MISSING) is a required parameter"
