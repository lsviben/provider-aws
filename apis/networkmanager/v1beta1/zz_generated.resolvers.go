...
func (mg *CustomerGatewayAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.CustomerGatewayArn),
		Extract:      resource.ExtractParamPath("arn", true),
		Reference:    mg.Spec.InitProvider.CustomerGatewayArnRef,
		Selector:     mg.Spec.InitProvider.CustomerGatewayArnSelector,
		To: reference.To{
			List:    &v1beta1.CustomerGatewayList{},
			Managed: &v1beta1.CustomerGateway{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.CustomerGatewayArn")
	}
	mg.Spec.InitProvider.CustomerGatewayArn = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.CustomerGatewayArnRef = rsp.ResolvedReference
...
func (mg *LinkAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.LinkID),
		Extract:      resource.ExtractResourceID(),
		Reference:    mg.Spec.InitProvider.LinkIDRef,
		Selector:     mg.Spec.InitProvider.LinkIDSelector,
		To: reference.To{
			List:    &LinkList{},
			Managed: &Link{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.LinkID")
	}
	mg.Spec.InitProvider.LinkID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.LinkIDRef = rsp.ResolvedReference
...
func (mg *TransitGatewayConnectPeerAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.TransitGatewayConnectPeerArn),
		Extract:      resource.ExtractParamPath("arn", true),
		Reference:    mg.Spec.InitProvider.TransitGatewayConnectPeerArnRef,
		Selector:     mg.Spec.InitProvider.TransitGatewayConnectPeerArnSelector,
		To: reference.To{
			List:    &v1beta1.TransitGatewayConnectPeerList{},
			Managed: &v1beta1.TransitGatewayConnectPeer{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.TransitGatewayConnectPeerArn")
	}
	mg.Spec.InitProvider.TransitGatewayConnectPeerArn = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.TransitGatewayConnectPeerArnRef = rsp.ResolvedReference
...
func (mg *TransitGatewayRegistration) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.TransitGatewayArn),
		Extract:      resource.ExtractParamPath("arn", true),
		Reference:    mg.Spec.InitProvider.TransitGatewayArnRef,
		Selector:     mg.Spec.InitProvider.TransitGatewayArnSelector,
		To: reference.To{
			List:    &v1beta1.TransitGatewayList{},
			Managed: &v1beta1.TransitGateway{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.TransitGatewayArn")
	}
	mg.Spec.InitProvider.TransitGatewayArn = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.TransitGatewayArnRef = rsp.ResolvedReference
