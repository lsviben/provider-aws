...
type ClusterSnapshot struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.dbClusterSnapshotIdentifier) || has(self.initProvider.dbClusterSnapshotIdentifier)",message="%!s(MISSING) is a required parameter"
