...
type OrganizationalUnit struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.parentId) || has(self.initProvider.parentId)",message="%!s(MISSING) is a required parameter"
