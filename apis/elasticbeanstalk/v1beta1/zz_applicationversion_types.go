...
type ApplicationVersion struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.application) || has(self.initProvider.application)",message="%!s(MISSING) is a required parameter"
