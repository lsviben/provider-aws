...
type SecurityGroupRule struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.fromPort) || has(self.initProvider.fromPort)",message="%!s(MISSING) is a required parameter"
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.toPort) || has(self.initProvider.toPort)",message="%!s(MISSING) is a required parameter"
