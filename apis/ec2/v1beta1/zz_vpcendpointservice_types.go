...
type VPCEndpointService struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.acceptanceRequired) || has(self.initProvider.acceptanceRequired)",message="%!s(MISSING) is a required parameter"
