...
type ManagedPrefixList struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.maxEntries) || has(self.initProvider.maxEntries)",message="%!s(MISSING) is a required parameter"
